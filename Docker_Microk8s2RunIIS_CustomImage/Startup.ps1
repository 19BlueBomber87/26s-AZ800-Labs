...
$Role1 = (Get-WindowsFeature | ? -Property name -like Web-Server).DisplayName

$LogicalCPUs = (Get-CimInstance Win32_Processor).NumberOfLogicalProcessors
# Build the replacement string
$replacement = "Welcome to Azure<br>Computer Name: $computerName<br>OS Version: $osVersion<br>Start Up Date\Time: $today<br>CPU: $cpu<br>IP: $podIP<br>Installed Roles:$Role1<br>Number of Logical CPUs:$LogicalCPUs"
