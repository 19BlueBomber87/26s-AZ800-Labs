...
# Set admin password and login before Exposing Virtualization Extensions (Nested Virtualization)
...
# Make sure machines have OS installed and first time login completed.  
# Expose Virtualization Extensions (Nested Virtualization)
$microK8sNodes = Get-VM | Where-Object -Property VMName -Like *micro-k8s-node0*
...
sudo microk8s kubectl scale deployment/iis --replicas=36
