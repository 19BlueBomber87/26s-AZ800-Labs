# =============================================
# Fixed Script: Create OU + Enable RDP + Wallpaper GPO + Link
# =============================================
...
New-SmbShare -Name $ShareName `
             -Path $Path `
             -Description "Wallpapers for Domain Users" `
             -ChangeAccess "Everyone" `
             -FullAccess "Domain Admins"   # Change to your domain admins group
...
# RDS - Add MCM-RDS-Users to Remote Desktop Users (GUI Steps)
...
# 5. Set the Settings
#    - Select: Enabled
#    - Wallpaper Name: \\server\share\wallpaper.jpg     (or local path)
