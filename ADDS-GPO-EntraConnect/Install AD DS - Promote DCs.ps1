...
# minecraftmoose.com domain controller
...
# minecraftmoose.com member server
...
# minecraftmoose.com privileged access workstation(Management Server)
...
# dev.moosewyre.fun domain controller
...
# dev.moosewyre.fun member server
New-Lab_VM ER-SVR01 -HyperVSwitch ER-Net -RAM 2GB -GeneralizedImageCore
Rename-Computer -NewName ER-SVR01 -Restart -Verbose *>&1
Save-VM -VMName ER-SVR01  -Verbose *>&1 

# megamooselabsfun.com domain controller
...
# megamooselabsfun.com member server
New-Lab_VM JUN-SVR01 -HyperVSwitch Jun-Net -RAM 2GB -GeneralizedImageCore
...
New-Lab_VM MCM-WAC01 -HyperVSwitch ER-Net -GeneralizedImageCore
Rename-Computer -NewName MCM-WAC01 -Restart -Verbose *>&1
Save-VM -VMName MCM-WAC01  -Verbose *>&1 
...
# quit
# list
# Join ANC-SVR01 to minecraftmoose.com
...
Install-WindowsFeature -Name RSAT-AD-PowerShell -IncludeAllSubFeature -Verbose *>&1
Install-WindowsFeature -Name RSAT-AD-Tools -IncludeAllSubFeature -Verbose *>&1
