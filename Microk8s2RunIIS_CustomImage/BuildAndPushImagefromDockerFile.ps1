...
docker run --rm -d -p 8081:80 --name container-iis77 custom-iis-site-with-microk8s-ws2025:1.0
...
# Test new Image
docker run -d -p 8081:80 --name container-iis01 mooselover/custom-iis-site-with-microk8s-ws2025:1.0
docker exec container-iis01 powershell -Command "ipconfig"
docker exec -it container-iis01 powershell 