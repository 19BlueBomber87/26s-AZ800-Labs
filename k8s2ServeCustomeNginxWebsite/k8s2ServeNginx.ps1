...
# ===================================================
# Note: For the Linux OS install Wizard to kick off, use at least 2GB.  After the OS installs you can reduce memory to 1GB on worker nodes.  

#Create VM for control plane.  Keep control plane node's memory at 4 GB. 
...
Start-VM -VMName $k8sNodeName -Verbose *>&1
# Install Linux OS
#Reduce Memory to 1GB After Linux OS Install
$k8sNodeName = "k8s-node01"
Stop-VM -VMName $k8sNodeName -Force -Verbose *>&1
Set-VMMemory -VMName $k8sNodeName  -StartupBytes 1GB -DynamicMemoryEnabled $false
Start-VM -VMName $k8sNodeName -Verbose *>&1
...
kubectl scale deployment custom-static-site --replicas=27
